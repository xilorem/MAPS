"""Planner workload balancing without rectangular-shape constraints."""
...
class StagePlan:
    ...
    physical_submesh: object | None = None
...
def _node_l2_transfer_workload_for_tile(
    ...
    for ref in tile_work.input_slices:
        ...
        if ref.tensor in initializer_tensors:
            continue
        if ref.tensor in graph_inputs or producer_stage_id is None:
